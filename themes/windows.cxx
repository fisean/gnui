...
//static const gnui::Frame_Box win98_menu_window_box(0, "2AARRMMUU", gnui::DOWN_BOX);
//extern const gnui::Frame_Box win98_down_box;
//static const gnui::Frame_Box win98_up_box(0, "2AAXXIIUU", &win98_down_box);
//       const gnui::Frame_Box win98_down_box(0, "2XXIIUUAA", &win98_up_box);
...
// newer versions of Windows & KDE look closer to FLTK default
//  gnui::Widget::default_style->buttonbox = &win98_up_box;
// this may be needed if fltk's default is the thin box:
//  gnui::Widget::default_style->box = &win98_down_box;
...
//    s->buttonbox = &win98_menu_window_box;
  ...
  if ((s = gnui::Style::find("item"))) {
    s->buttonbox(gnui::NO_BOX); // no box around checkmarks
  }

  if ((s = gnui::Style::find("menu bar"))) {
    s->highlight_color(gnui::GRAY75); // needed for title highlighting
  }
