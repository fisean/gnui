...
/*! Symbolic names for some of the indexed colors.
  ...
  gnui::FrameBox and the old gnui1.1 names used for these levels.
...
enum {
  ...
  GRAY00	= 32, //!< hex=00, dec=.00, framebox=A, gnui1 = GRAY0, GRAY_RAMP
  ...
  GRAY33	= 39, //!< hex=5c, dec=.36, framebox=H, gnui1 = DARK3
  ...
  GRAY60	= 45, //!< hex=ab, dec=.67, framebox=N, gnui1 = DARK2
  GRAY65	= 46, //!< hex=b8, dec=.72, framebox=O
  GRAY66	= 47, //!< hex=c5, dec=.77, framebox=P, gnui1 = DARK1, INACTIVE_COLOR
  GRAY70	= 48, //!< hex=d2, dec=.82, framebox=Q
  GRAY75	= 49, //!< hex=e0, dec=.88, framebox=R, gnui1 = GRAY, SELECTION_COLOR
  GRAY80	= 50, //!< hex=e5, dec=.90, framebox=S
  GRAY85	= 51, //!< hex=ea, dec=.92, framebox=T, gnui1 = LIGHT1
  //unnamed entry	   hex=ef, dec=.94, framebox=U
  GRAY90	= 53, //!< hex=f4, dec=.96, framebox=V, gnui1 = LIGHT2
  GRAY95	= 54, //!< hex=f9, dec=.98, framebox=W
  GRAY99	= 55, //!< hex=ff, dec=1.0, framebox=X, gnui1 = LIGHT3
