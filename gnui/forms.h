...
#include <gnui/Fl.h>
#include <gnui/Fl_Group.h>
#include <gnui/Fl_Window.h>
#include <gnui/fl_draw.h>
...
enum {	// "p" argument values:
  ...
  FL_PLACE_SIZE = 8,	// fixed size, normal gnui behavior
...
inline void fl_set_graphics_mode(int r, int /*d*/) {
  ...
  // d should add FL_DOUBLE, but that always fails in gnui 2.0
}
...
#include <gnui/Fl_Box.h>
forms_constructorb(Fl_Box, fl_add_box)

#include <gnui/Fl_Browser.h>
...
#include <gnui/fl_ask.h>
#include <gnui/fl_show_colormap.h>
...
#include <gnui/fl_file_chooser.h>
...
#include <gnui/Fl_Value_Slider.h>
