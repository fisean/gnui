 ...
 *
 * These functions are not in the gnui namespace because they really
 * should not be part of gnui. They are used by the file chooser.
 * THESE FUNCTIONS MAY BE CHANGED OR DELETED IN FUTURE VERSIONS. DO
 * NOT USE THEM, AS THEY ARE NOT AN OFFICIAL PART OF gnui!
 */
