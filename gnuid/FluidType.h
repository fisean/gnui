...
// Fast Light toolkit Interface Designer (gnuid)
//
...
#ifndef gnui_gnuid_type_h
#define gnui_gnuid_type_h
...
class FLUID_API FluidType {
  ...
  friend gnui::Widget *make_type_browser(int,int,int,int,const char *l);
...
////////////////////////////////////////////////////////////////
// This header file also declares all the global functions in gnuid:
