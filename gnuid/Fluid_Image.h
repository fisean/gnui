...
// "$Id$"
//
// Pixmap image header file for the Fast Light Tool Kit (GNUI).
//
// This class stores the image labels for widgets in gnuid.  This is
// not a class in gnui itself, and this will produce different types of
...
public:
  ...
  void increment();
  virtual const gnui::Symbol* symbol() = 0; // return the gnui Symbol object
