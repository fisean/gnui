// "$Id$"
//
// C function type code for the Fast Light Tool Kit (GNUI).
//
...
static void load_comments_preset(gnui::Preferences &menu) 
{
  static const char * const predefined_comment[] = {
    ...
    "GNUI/Header", "GNUI/Footer" };
  menu.set("n", 6);
  gnui::Preferences db(gnui::Preferences::USER, "gnui.org", "gnuid_comments");
  for (int i=0; i<6; i++) {
...
void CommentType::open() {
    ...
    {
	int i=0, n=0;
	gnui::Preferences menu(gnui::Preferences::USER, "gnui.org", "gnuid_comments_menu");
