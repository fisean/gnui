...
// "$Id$"
//
// Code output routines for the Fast Light Tool Kit (GNUI).
//
...
int write_code(const char *s, const char *t) {
  ...
  const char *hdr = "\
// generated by Fast Light User Interface Designer (gnuid) version %.4f\n\n";
  fprintf(header_file, hdr, GNUI_VERSION);
  fprintf(code_file, hdr, GNUI_VERSION);
